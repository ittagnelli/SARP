...
CREATE TABLE "new_pcto_Pcto" (
    ...
    "idClasse" INTEGER NOT NULL DEFAULT 1,
    "firma_pcto" BOOLEAN NOT NULL DEFAULT false,
    ...
    CONSTRAINT "pcto_Pcto_idClasse_fkey" FOREIGN KEY ("idClasse") REFERENCES "Classe" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_pcto_Pcto" ("anno_scolastico", "contabilizzato", "createdAt", "creatoDa", "dataFine", "dataInizio", "descrizione", "durata_ore", "id", "idAzienda", "idClasse", "idTutor", "titolo", "tutor_aziendale", "updatedAt") SELECT "anno_scolastico", "contabilizzato", "createdAt", "creatoDa", "dataFine", "dataInizio", "descrizione", "durata_ore", "id", "idAzienda", "idClasse", "idTutor", "titolo", "tutor_aziendale", "updatedAt" FROM "pcto_Pcto";
