...
INSERT INTO "new_pcto_Pcto" ("anno_scolastico", "contabilizzato", "createdAt", "creatoDa", "dataFine", "dataInizio", "descrizione", "durata_ore", "id", "idAzienda", "idTutor", "titolo", "tutor_aziendale", "updatedAt") SELECT "anno_scolastico", "contabilizzato", "createdAt", "creatoDa", "dataFine", "dataInizio", "descrizione", "durata_ore", "id", "idAzienda", "idTutor", "titolo", "tutor_aziendale", "updatedAt" FROM "pcto_Pcto";
