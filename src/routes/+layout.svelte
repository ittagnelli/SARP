	...
	<div class="page" in:fade={{ delay: 200, duration: 1500 }}>
		<Navbar>
			<NavMenu resource="menu_doc" text="Documentazione" icon="vocabulary">
				...
				<NavSubItem
					resource="menu_doc_programmazione"
					text="Programmazione Annuale"
					link="/documentazione/programmazione_annuale"
				/>
				<NavSubItem
					resource="menu_doc_sicurezza"
					text="Sicurezza sul Lavoro"
					link="/documentazione/sicurezza_lavoro"
				/>
			...
			<NavMenu resource="menu_pcto" text="PCTO" icon="building-factory-2">
				...
				<NavSubItem
					resource="menu_valutazione_studenti"
					text="Valutazione Studenti"
					link="/pcto/valutazione_studenti"
				/>
				<NavSubItem
					resource="menu_verifica_stato"
					text="Verifica Stato"
					link="/pcto/verifica_stato"
				/>
			</NavMenu>
			<NavMenu resource="menu_pdp" text="PDP" icon="certificate">
				<NavSubItem resource="menu_sezionea" text="Sezione A" link="/pdp/sezionea" />
				<NavSubItem resource="menu_mipresento" text="Mi Presento" link="/pdp/mipresento" />
				<NavSubItem
					resource="menu_autovalutazione"
					text="Autovalutazione"
					link="/pdp/autovalutazione"
				/>
				<NavSubItem
					resource="menu_patto_educativo"
					text="Patto Educativo"
					link="/pdp/patto_educativo"
				/>
				<NavSubItem resource="menu_pdp_template" text="Template Docente" link="/pdp/template" />
				<NavSubItem
					resource="menu_griglia_osservativa"
					text="Griglia Osservativa"
					link="/pdp/griglia_osservativa"
				/>
				<NavSubItem
					resource="menu_griglia_diagnosi"
					text="Griglia Diagnosi"
					link="/pdp/griglia_diagnosi"
				/>
			...
			<NavMenu resource="menu_programmazione" text="Programma Annuale" icon="list">
				<NavSubItem
					resource="menu_programmazione_template"
					text="Template Docente"
					link="/programmazione/template"
				/>
				<NavSubItem
					resource="menu_programmazione_docente"
					text="Programmazione Docente"
					link="/programmazione/docente"
				/>
				<NavSubItem
					resource="menu_programmazione_classe"
					text="Programmazione Classe"
					link="/programmazione/classe"
				/>
			</NavMenu>
			<NavMenu resource="menu_sicurezza_lavoro" text="Sicurezza sul Lavoro" icon="shield-half">
				<NavSubItem
					resource="menu_sicurezza_corsi"
					text="Corsi Sicurezza"
					link="/sicurezza_sul_lavoro/corsi"
				/>
				<NavSubItem
					resource="menu_sicurezza_test"
					text="Test Sicurezza"
					link="/sicurezza_sul_lavoro/test"
				/>
			</NavMenu>
			<NavMenu resource="menu_tools" text="Tools" icon="tools">
				<NavSubItem
					resource="menu_convert_to_print"
					text="Convert to Print"
					link="/tools/convert-to-print"
				/>
			</NavMenu>
		</Navbar>
