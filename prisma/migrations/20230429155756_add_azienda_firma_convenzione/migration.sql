...
INSERT INTO "new_pcto_Azienda" ("createdAt", "creatoDa", "dataConvenzione", "dataProtocollo", "direttore_codiceF", "direttore_natoA", "direttore_natoIl", "direttore_nome", "email_privacy", "id", "idConvenzione", "indirizzo", "istituto", "nome", "piva", "telefono", "updatedAt") SELECT "createdAt", "creatoDa", "dataConvenzione", "dataProtocollo", "direttore_codiceF", "direttore_natoA", "direttore_natoIl", "direttore_nome", "email_privacy", "id", "idConvenzione", "indirizzo", "istituto", "nome", "piva", "telefono", "updatedAt" FROM "pcto_Azienda";
