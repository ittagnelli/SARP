...
<h1>Scuola Agnelli Resource Planning (SARP)</h1>
<br /><br />
<h2>Obiettivi</h2>
<ul>
	...
	<li>
		agevolare le attività amministrative dei vari attori coinvolti (docenti, preside,
		amministrazione)
	</li>
	<li>
		"palestra" per gli studenti del triennio informatico per cimentarsi con un'attività non
