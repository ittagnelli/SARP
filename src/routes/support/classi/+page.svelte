<script>
	...
	const form_schema = yup.object().shape({
		// tipo: yup.string().required('Tipo utente necessario'),
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-lg-2">
							<InputText label="Classe" name="classe" placeholder="Classe" readonly bind:val={form_values.classe} {errors} />
						</div>
						<div class="col-lg-2">
							<InputText label="Istituto" name="istituto" placeholder="Istituto" readonly bind:val={form_values.istituto} {errors} />
						</div>
                        <div class="col-lg-2">
							<InputText label="Sezione" name="sezione" placeholder="Sezione" readonly bind:val={form_values.sezione} {errors} />
						</div>
                        <div class="col-lg-6">
