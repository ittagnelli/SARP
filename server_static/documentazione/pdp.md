...
Nella schermata della sezione *Mi presento*, voce di *PDP*, sono presenti diverse tabelle contenenti le informazioni degli utenti. Ogni tabella visualizza dettagli specifici degli utenti, come *nome*, *cognome*, *indirizzo email*. Inoltre, è indicato se gli utenti hanno il **Piano Didattico Personalizzato (PDP)** o meno.
...
- **COMPELTO**: indica se lo studente ha il PDP completo (flag verde) oppure no (flag rosso)
- **AZIONI**: azioni che è possibile svolgere su ogni singolo utente
  - **Mi Presento al Consiglio di Classe**: form per presentarsi al consiglio di classe
    - ![Form Mi presento](/img/documentazione/pdp/pdp_form_mipresento.png)
      - **Nome e Cognome:** Questa parte richiede semplicemente il nome e il cognome dello studente, per identificarlo univocamente.
...
Anche questa sezione, come quella di prima, **deve essere compilata da tutti gli stundeti della scuola**.
...
- **AZIONI**: azioni che è possibile svolgere su ogni singolo utente
  - **Aggiornare il Patto Educativo**: form per configurare il patto educativo tra la scuola e la famiglia/tutor
    - ![Form_patto_educativo](/img/documentazione/pdp/pdp_form_patto_educativo.png)
      ...
      - **Patto educativo Completa:** Quando il responsabile BES marca il patto educativo come completo non ha più la necessità ulteriore di modificarla. Finché non e' completa il documento PDP non può essere generato. Solo quando tutte le parti sono complete allora il PDP può essere generato.

# PDP: Template Docente

![template_docente_home](/img/documentazione/pdp/pdp_template_docente_home.png)

Descriviamo ora le colonne di questa tabella:
- **NOME**: nome del template
- **NOTE**: note/appunti a riguardo del template
- **AZIONI**: azioni che è possibile svolgere su ogni singolo tamplate
  - **Aggiorna tamplate**: form per aggiornare il template
  - **Rimuovi template pdp**: pulsante per rimuovere il template

## Come creare un template docente pdp?
...
- **Schiaccia sul tasto "Aggiungi Template":** Cerca il pulsante blu "+ Aggiungi Template" situato in alto a destra dell'interfaccia. 
  - **Rispondi alle domande del form:**
    - ![Form_template_docente](/img/documentazione/pdp/pdp_form_template_docente.png)
      ...
      - **Note:** Campo facoltativo, per inserire delle proprie note a riguardo del template.

      - **PDP Completa:** Quando il responsabile BES marca PDP come completo non ha più la necessità ulteriore di modificarla. Finché non e' completa il documento PDP non può essere generato. Solo quando tutte le parti sono complete allora il PDP può essere generato.

# PDP: Griglia osservativa
...
- **AZIONI**: azioni che è possibile svolgere su ogni singolo utente
  - **Aggiorna griglia osservativa**: form per valuatre tramite una serie di 39 domande chiuse lo studente
    - ![Form_griglia_oss](/img/documentazione/pdp/pdp_form_griglia_oss.png)
...
- **AZIONI**: azioni che è possibile svolgere su ogni singolo utente
  - **Aggiorna griglia diagnosi**: form per completare la griglia diagnosi tramtie l'inserimetno nei campi opportuni
    - ![Form_griglia_diagnosi](/img/documentazione/pdp/pdp_form_griglia_diagnosi.png)
...
![pdp_docente_home](/img/documentazione/pdp/pdp_docente_home.png)
...
- **AZIONI**: azioni che è possibile svolgere su ogni singolo utente
  - **Crea o aggiorna PDP per lo studente**: form per inserire o creare il proprio template.
    - ![Form_pdp_docente](/img/documentazione/pdp/pdp_form_docente.png)
...
![pdp_studente_home](/img/documentazione/pdp/pdp_studenti_home.png)

Descriviamo ora le colonne di questa tabella:
- **CLASSE**: classe dello studente
- **Studente**: nome e cognome dello studente
- **Sintesti vocale**: indica se lo studente ha la sintesti vocale (flag verde) oppure no (flag rosso)
...
- **Meterie complete**: indica quanti docenti hanno inserito il proprio tamplate nelle sue materie
- **PDP completo**: indica se lo studente ha il PDP completo (flag verde) oppure no (flag rosso)