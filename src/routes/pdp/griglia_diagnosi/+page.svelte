<script>
	...
	studenti.forEach((s) => {
		if (s.griglia_pdp_b == null) s.griglia_pdp_b = griglia_pdp_b;
	});
...
<Table
	columns={[
		...
		{ name: 'griglia_pdp_b_done', type: 'boolean', display: 'completo', search: true }
	]}
	rows={studenti}
	page_size={10}
									...
									<tr>
										...
										<td class="center"
											><input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['brano_velocita']}
											/></td
										>
										<td class="center"
											><input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['brano_correttezza']}
											/></td
										>
									</tr>
									<tr>
										...
										<td class="center"
											><input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['parole_velocita']}
											/></td
										>
										<td class="center"
											><input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['parole_correttezza']}
											/></td
										>
									</tr>
									<tr>
										...
										<td class="center"
											><input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['notparole_velocita']}
											/></td
										>
										<td class="center"
											><input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['notparole_correttezza']}
											/></td
										>
									</tr>
									<tr>
									...
									<tr>
										<td class="center">
											...
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['brano_cronaca']}
											/>
										</td>
										<td class="center">
											BRANO INFORMATIVO
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['brano_informativo']}
											/>
										</td>
										<td class="center">
											TOTALE
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['brano_totale']}
											/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td class="center">
											...
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['dettato_brano']}
											/>
										</td>
										<td class="center">
											...
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['omografe']}
											/>
										</td>
										<td class="center">
											LISTA DI PAROLE
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['lista_parole']}
											/><br />
											LISTA DI NON PAROLE
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['lista_notparole']}
											/>
										</td>
									</tr>
									<tr>
										<td class="center" colspan="3">
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['scrittura_altro']}
											/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td class="center">
											...
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['grafia_lele']}
											/>
										</td>
										<td class="center">
											uno<br />
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['grafia_uno']}
											/>
										</td>
										<td class="center">
											Numeri in parole <br />
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['grafia_numeri']}
											/><br />
										</td>
									</tr>
									<tr>
										<td class="center" colspan="3">
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['grafia_altro']}
											/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td class="center">
											...
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['calcolo_area_numero']}
											/>
										</td>
										<td class="center">
											AREA DEL CALCOLO<br />
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['calcolo_area_calcolo']}
											/>
										</td>
										<td class="center">
											SENSO DEL NUMERO<br />
									...
									<tr>
										<td class="center">
											...
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['calcolo_conteggio']}
											/>
										</td>
										<td class="center">
											...
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['calcolo_moltiplicazioni']}
											/>
										</td>
										<td class="center">
											Triplette<br />
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['senso_triplette']}
											/><br />
										</td>
									</tr>
									<tr>
										<td class="center">
											...
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['calcolo_lettura']}
											/>
										</td>
										<td class="center">
											Calcolo a mente<br />
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['calcolo_mente']}
											/>
										</td>
										<td class="center">
											Inserzioni<br />
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['senso_inserzioni']}
											/><br />
										</td>
									</tr>
									<tr>
										<td class="center">
											...
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['calcolo_scrittura']}
											/>
										</td>
										<td class="center">
											Calcolo rapido<br />
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['calcolo_rapido']}
											/>
										</td>
										<td class="center">
											...
											<input
												class="input"
												type="text"
												bind:value={form_values.griglia_pdp_b['senso_approssimativo']}
											/><br />
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="center"
											><input
												class="inputlg"
												type="text"
												bind:value={form_values.griglia_pdp_b['altro_linguistica']}
											/></td
										>
									</tr>
									<tr>
										...
										<td class="center"
											><input
												class="inputlg"
												type="text"
												bind:value={form_values.griglia_pdp_b['altro_memoria']}
											/></td
										>
									</tr>
									<tr>
										...
										<td class="center"
											><input
												class="inputlg"
												type="text"
												bind:value={form_values.griglia_pdp_b['altro_attenzione']}
											/></td
										>
									</tr>
									<tr>
										...
										<td class="center"
											><input
												class="inputlg"
												type="text"
												bind:value={form_values.griglia_pdp_b['altro_elaborazione']}
											/></td
										>
									</tr>
									<tr>
										...
										<td class="center"
											><input
												class="inputlg"
												type="text"
												bind:value={form_values.griglia_pdp_b['altro_forza']}
											/></td
										>
									</tr>
								</table>
