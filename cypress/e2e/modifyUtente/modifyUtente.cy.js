describe('Vista Utenti', () => {
    ...
    it('Valid user Able to Login', () => {
      ...
      cy.wait(200);
      cy.get(':nth-child(1) > :nth-child(1) > .mb-3 > .form-control').type('Gino');
      cy.wait(10);
      ...
      cy.wait(10);
      cy.get(':nth-child(2) > :nth-child(1) > .mb-3 > .form-control').type('gino.pluto@istitutoagnelli.it');
      cy.wait(10);
      ...
      cy.get(':nth-child(1) > :nth-child(11) > a.s-VDIlRFsbz_G7 > .ti').click();
      cy.wait(250);
      cy.get(':nth-child(1) > :nth-child(1) > .mb-3 > .form-control').clear();
      cy.get(':nth-child(1) > :nth-child(1) > .mb-3 > .form-control').type('Gianfraschio');
      cy.wait(10);
      cy.get('.btn-success').click();
      /* ==== End Cypress Studio ==== */
    })
