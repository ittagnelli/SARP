                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">       
                                ...
                                />
                                <br><br>
                                <input type="text" name="disc_1" bind:value={(form_values.griglia_pdp_c2[0]).disc_1} />
                                <input type="text" name="cadenza_1" bind:value={(form_values.griglia_pdp_c2[0]).cadenza_1} /><br><br>
                                <input type="text" name="disc_2" bind:value={(form_values.griglia_pdp_c2[0]).disc_2} />
                                <input type="text" name="cadenza_2" bind:value={(form_values.griglia_pdp_c2[0]).cadenza_2} /><br><br>
                                <input type="text" name="disc_3" bind:value={(form_values.griglia_pdp_c2[0]).disc_3} />
                                <input type="text" name="cadenza_3" bind:value={(form_values.griglia_pdp_c2[0]).cadenza_3} /><br><br>
                                <input type="text" name="disc_4" bind:value={(form_values.griglia_pdp_c2[0]).disc_4} />
                                <input type="text" name="cadenza_4" bind:value={(form_values.griglia_pdp_c2[0]).cadenza_4} />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">       
                                ...
                                <input type="text" name="answer16" size="80" bind:value={(form_values.griglia_pdp_c2[16]).answer} />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">       
                                ...
                                <input type="text" name="answer17" size="80" bind:value={(form_values.griglia_pdp_c2[17]).answer} />
                            </div>
                        </div>
                    </div>
                    {/if}
