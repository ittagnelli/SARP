describe('Vista Utenti', () => {
    ...
    it('Valid user Able to Login', () => {
      ...
      cy.wait(300);
      cy.get(':nth-child(1) > .col-lg-4 > .mb-3 > .form-control').type('2023/11');
      cy.get('.col-lg-8 > .mb-3 > .form-control').type('Gino and Co');
      ...
      cy.get(':nth-child(2) > .form-selectgroup-label').click();
