describe('Vista Utenti', () => {
    ...
    it('Valid user Able to Login', () => {
      ...
      cy.wait(300);
      cy.get(':nth-child(1) > .col-lg-4 > .mb-3 > .form-control').type('2023/20');
      ...
      cy.get(':nth-child(1) > .col-lg-4 > .mb-3 > .form-control').clear().type('2023/14');
      cy.get(':nth-child(4) > :nth-child(1) > .mb-3 > .form-control').clear().type('Lillo Lilli');
      /* ==== End Cypress Studio ==== */
    })
  })